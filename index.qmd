...
## why Python? {.galah auto-animate="true"}
...
::: {.column width="70%" style="margin-left:50px;"}
::: {style="font-size: 50%;"}
![](images/Popularity_Programming_Languages.png){height=369


}\
![](images/PYPL_August_2023.png){height=380}
:::
:::
::::
...
::: {style="color: #ffffff; font-size: 200%"}
<b>Build the query "Download record counts of Peron's tree frog *(Litoria peronii)* since 2018 in New South Wales by FrogID"</b><br>
:::


## Check scientific name for Peron's tree frog {.galah}
...
To get a list of all possible filters, look at all fields
...
Search for an appropriate field name with "year"
...
Add the year value to your query
...
Find appropriate filter for New South Wales
...
Get values available for Australian states, and find New South Wales
...
Add the state value to your query
...
Find the appropriate field and values à la the Australian states
...
frogs
```
Get Australian state and territory boundaries ([link to shapefile](https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/digital-boundary-files/STE_2021_AUST_SHP_GDA2020.zip)), and select New South Wales
```{python}
#| echo: true
#| code-overflow: scroll
...
#| echo: true
#| code-overflow: scroll
states[states["STE_NAME21"] == "New South Wales"].plot(edgecolor = "#5A5A5A", linewidth = 0.5, facecolor = "white")
```
Add occurrence records to the map
```{python}
#| echo: true
#| code-overflow: scroll
ax = states[states["STE_NAME21"] == "New South Wales"].plot(edgecolor = "#5A5A5A", linewidth = 0.5, facecolor = "white")
...
#| echo: true
#| code-overflow: scroll
#           "dataResourceName=[FrogID,iNaturalist Australia]",
galah.atlas_counts(
  taxa="litoria peronii",
  filters=["year>=2018",
           "cl22=New South Wales",
